...
total_siswa = 350
unit_cost = total_bersih / total_siswa

# Tampilan Visual Ringkasan Angka Utama
...
st.markdown("---")
st.success(f"🎯 BIAYA RIIL PER SISWA (UNIT COST BERSHI): Rp {int(unit_cost):,} / Siswa per Tahun")
st.markdown("---")

# Tabel Detail Laporan Kepala Sekolah
st.write("📋 **Daftar Rekomendasi Detail Proposal Anggaran Sekolah:**")
